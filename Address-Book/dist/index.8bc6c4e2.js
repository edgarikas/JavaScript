function render() {
    ...
    if (document.querySelector(`#${inputsId}`)) document.querySelector(`#${inputsId}`).remove();
...
document.querySelector("#address-book-inputs").addEventListener("submit", (e)=>{
    e.preventDefault();
...
//# sourceMappingURL=index.8bc6c4e2.js.map
